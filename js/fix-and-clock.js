$(document).ready(function() {
    ...
    //		$('#pageLogin').addClass('initLog').delay(500).queue(function() { $(this).removeClass('initLog').addClass('initLogExit'); $(this).dequeue(); });;
    //		$('#page, #head').delay(500).queue(function() { $(this).addClass('vis'); $(this).dequeue(); });
    //		$('.window').delay(500).queue(function() { $(this).addClass('windows-vis'); $(this).dequeue(); });
    ...
    $('.tooltip-pass').hide();
    $('.submit').removeClass('submit').addClass('charge');
    $('#pageLogin').addClass('initLog').delay(500).queue(function() {
        $(this).removeClass('initLog').addClass('initLogExit');
        $(this).dequeue();
    });
    ;
    $('#page, #head').delay(500).queue(function() {
        $(this).addClass('vis');
        $(this).dequeue();
    });
    ...
    var a = 3;
    $('.content,.specific,.project,.share').draggable({
        handle: '.title-inside', 
...
var item = $('<div class="fresh"></div>').hide();
    ...
    $(".dock li a[data-rel=showOp]").click(function(e) {
        ...
        $("#warning").delay(1630).queue(function() {
            $(this).show();
            $(this).dequeue();
        });
    });
